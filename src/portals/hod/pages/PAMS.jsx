    ...
    <div className="space-y-6">
      <div className="flex items-center gap-2">
        ...
        <div>
          ...
          <p className="text-gray-600">Confirm after meeting or return to employee for changes.</p>
        </div>
      </div>
      ...
      {selected && (
        <Card>
          ...
          <div className="flex flex-wrap items-center justify-end gap-2 mt-4">
            ...
            <Button onClick={() => handleDecision('confirm')} className="flex items-center gap-2">
