      ...
      >
        {selectedExEmployee && (
          <div className="space-y-6">
            ...
            {selectedExEmployee.publications && selectedExEmployee.publications.length > 0 && (
              <div className="border rounded-xl p-4">
                ...
                <ul className="divide-y">
                  {selectedExEmployee.publications.map((pub, idx) => (
                    <li key={idx} className="py-2">
                      ...
                      {pub.type === 'conference' && pub.webLink && (
                        <a
                          href={pub.webLink}
                          className="text-blue-600 text-xs"
                          target="_blank"
